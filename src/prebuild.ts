...
//         'x-bg-1':{
//             'type':'statement',
//             statement:`bg-lg-135deg-1e1b4b-0f172a
//   --bf[cont,pa,flex-center,w-130px,h-130px,bgc-rgba-99-102-241-0.25,br-50p,t--30px,l--30px,backdrop-filter-blur-12px,bxs-0px-0px-40px-rgba-99-102-241-0.3]
//   --af[cont,pa,w-100px,h-100px,br-50px,bgc-rgba-244-114-182-0.2,btm--20px,r--20px,b-1px-s-rgba-255-255-255-0.1,bxs-0px-0px-30px-rgba-244-114-183-0.3]`
//         },
//         'x-bg-cyberpunk-grid':{
//             'type':'raw',
//             statement:`
//             .x-bg-cyberpunk-grid {
//             --x-bg-cyberpunk-grid-color:#00001a;
//             --x-bg-cyberpunk-grid-line-color:0 255 200;
//             background: var(--x-bg-cyberpunk-grid-color);
//             perspective: 400px;
//         }

//         .x-bg-cyberpunk-grid::before {
//             content: '';
//             position: absolute;
//             width: 200%;
//             height: 200%;
...
//             left: -50%;
//             background-image:
//                 linear-gradient(rgba(var(--x-bg-cyberpunk-grid-line-color) / 0.3) 1px, transparent 1px),
//                 linear-gradient(90deg, rgba(var(--x-bg-cyberpunk-grid-line-color) / 0.3) 1px, transparent 1px);
//             background-size: 30px 30px;
//             transform: rotateX(55deg);
//             transform-origin: 50% 0%;
//         }

//         .x-bg-cyberpunk-grid::after {
//             content: '';
//             position: absolute;
//             inset: 0;
//             background:
//                 linear-gradient(180deg, var(--x-bg-cyberpunk-grid-color) 0%, transparent 40%, var(--x-bg-cyberpunk-grid-color) 100%),
//                 radial-gradient(ellipse at 50% 0%, rgba(var(--x-bg-cyberpunk-grid-line-color) / 0.25) 0%, transparent 60%);
//         }`},
        'x-btn':{
            type:'statement',
...
//         },
    ...
    statement:`pr oh
        ...
        --has(__[class~=is-active][class~=x-screen-push][class~=x-screen-up])__[class~=x-screen-main]-mt--push-down:100dvh
        --has(__[class~=is-active][class~=x-screen-push][class~=x-screen-down])__[class~=x-screen-main]-mt--push-up:--100dvh
        --has(__[class~=is-active][class~=x-screen-push][class~=x-screen-right])__[class~=x-screen-main]-ml--push-left:--100p
        --has(__[class~=is-active][class~=x-screen-push][class~=x-screen-left])__[class~=x-screen-main]-ml--push-right:100p
         `,
...
'x-screen':{
    ...
    statement:`w--x-screen-width:100p h--x-screen-height:100p pa transition-property-margin_transform
        ...
        [class~=is-active]-transform-translate-0
